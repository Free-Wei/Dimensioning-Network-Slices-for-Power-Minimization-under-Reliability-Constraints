...
%for iter = 1
   ...
   % active_set = [1,2,3];
    ...
    for iteration = 1:5
    filename = ['final_com_1s_50ms_5ms_slices_final_Twaren.graphml_',num2str(seed),'_complexity_delay1e4_iter200_contolerance1-2_inter_',num2str(iter),'_test_greedy_',num2str(iteration),'.mat'];
    load(filename);
    ...
    filename = ['final_com_1s_50ms_5ms_slices_final_Twaren.graphml_',num2str(seed),'_complexity_delay1e4_iter200_contolerance1-2_inter_',num2str(iter),'_test_greedy_',num2str(pos),'.mat'];
    load(filename);
...
xlabel('Comp/Comm complexity of slice mMTC (\cdot Default range) [instr/req, bytes/req]');
...
threshold_axis = find(yt==threshold_value);
set(gca, 'YTick',yt(threshold_axis:end), 'YTickLabel',sprintfc('%.2f',yt(threshold_axis:end)))
xlabel('Comp/Comm complexity of slice eMBB (\cdot Default range) [instr/req, bytes/req]');
%xlabel('Routing probability of slices');
ylabel('Success or failure');
legend('OptRes','PropRes50','PropRes75','PropRes100');
...
threshold_axis = find(yt==threshold_value);
set(gca, 'YTick',yt(threshold_axis:end), 'YTickLabel',sprintfc('%.2f',yt(threshold_axis:end)))
xlabel('Comp/Comm complexity of slice URLLC (\cdot Default range) [instr/req, bytes/req]');
%xlabel('Routing probability of slices');
ylabel('Success or failure');
legend('OptRes','PropRes50','PropRes75','PropRes100');
...
xlabel('Comp/Comm complexity of slices (\cdot Default range) [instr/req, bytes/req]');
