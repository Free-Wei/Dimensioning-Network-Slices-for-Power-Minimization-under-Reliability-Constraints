function [t,round1,step,upp_round1,low_round1] = approxiamate_t(dl,traffic_path,coefficient_alpha,coefficient_beta,NodeTable,EdgeTable,total_arrival,num_slices,prob_fail,replicas_destinations,x_range_max,step,round,upp_round,low_round)
...
for s = 1:num_slices
    ...
    for i = 1:count(s)
        upper_bound{s}(i) = dl(s)*(rate{s}(i)/total_rate)/round1(s);
